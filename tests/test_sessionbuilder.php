...
class SessionBuilderTest extends PHPUnit_Framework_TestCase{
    ...
    public function testBasicPreKeyV2(){
        ...
        try {
            ...
            $preKey = new PreKeyWhisperMessage(null,null,null,null,null,null,null,$outgoingMessage->serialize());
            $bobStore->saveIdentity(self::ALICE_RECIPIENT_ID, $preKey->getIdentityKey());
        }
    ...
    public function test_basicKeyExchange(){
        ...
        bobStore          = InMemoryAxolotlStore()
        bobSessionBuilder = SessionBuilder(bobStore, bobStore, bobStore, bobStore, self::ALICE_RECIPIENT_ID, 1)
