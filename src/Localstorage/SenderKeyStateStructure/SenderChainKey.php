...
/**
 * Generated from protobuf message <code>localstorage.SenderKeyStateStructure.SenderChainKey</code>
 */
...
class_alias(SenderChainKey::class, \Localstorage\SenderKeyStateStructure_SenderChainKey::class);
