...
class InvalidMessageException extends Exception {
	...
	public static function constructor__7453339f ($detailMessage, $exceptions) // [String detailMessage, List<Exception> exceptions]
	{
		$me = new self();
		$me->__init();
		/* constructor resolution using types matched overloadcode: */
		parent::constructor__($detailMessage, $exceptions->get(0));
		return $me;
	}
}
